                        ...
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($publishes as $year)
                                        <li><a title="Phim {{ $year }}"
                                                href="{{ route('publish', $year) }}">Năm {{ $year }}</a>
                                        </li>
                                    @endforeach
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($genres as $each)
                                        <li><a title="{{ $each->title }}"
                                                href="{{ route('genre', $each->slug) }}">{{ $each->title }}</a></li>
                                    @endforeach
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($countries as $each)
                                        <li><a title="{{ $each->title }}"
                                                href="{{ route('country', $each->slug) }}">{{ $each->title }}</a>
                                        </li>
                                    @endforeach
                            ...
                            @foreach ($categories as $each)
                                <li class="mega"><a title="{{ $each->title }}"
                                        href="{{ route('category', $each->slug) }}">{{ $each->title }}</a></li>
                            @endforeach
